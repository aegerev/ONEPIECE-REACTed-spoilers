...
function Section() {
      ...
      return (
        <section className="section" style={{ backgroundColor: '#f0f0f0', padding: '20px' }}>
            <h2>Usopp will get a new power-up on Elbaf</h2>
            <p>
            People make fun of Usopp because he is a coward, while not understanding his motivations and his character development: you can’t be truly brave if you aren’t afraid. Everytime Usopp is terrified, he somehow ends pulling himself together and actually contributing to the mission. And his cowardice has been crucial for the Straw Hats victory multiple times already.
            </p>

            <p>
            The Straw Hats crew is united by their common goal: help Luffy become King of the Pirates and fulfill their own individual dreams. I seriously doubt any crew member will fulfill their dreams before Luffy becomes the King of the Pirates. So why would Usopp? 
            ...
            <p>
            He is the only member that has a dream that is not a tangible item or something that can be acquired after clearing a specific objective. It is a dream about self acceptance. He wants his tales to be told by others. He wants his lies to become true.
            <br/> <br/>
